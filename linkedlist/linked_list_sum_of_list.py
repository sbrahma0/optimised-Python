...
# To delete a node with the given position
    ...
    # This function is to get the sum of 2 lists in linked list style
    # https://youtu.be/dm9drjU-DuM?list=PL5tcWHG-UPH112e7AN7C-fwDVPVrt0wpV
    def sum_list(self, llist):
        ...
        while p or q: # i and j are the numbers from p and q lists we need to add
            if not p:
                i = 0
            else:
                i = p.data
